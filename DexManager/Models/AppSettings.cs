...
namespace DexManager.Models
{
    ...
    public sealed class AppSettings
    {
        ...
        public void EnsureDefaults()
        {
            ...
            {
                // Older releases enabled screen-off by default. Keep the
                // phone display on after upgrade so a DeX drag cannot appear
                // to power down the device unexpectedly.
            ...
            if (oldSchemaVersion < 26)
            {
                foreach (var profile in DeviceRunSettingsProfiles)
                {
                    ...
                    if (profile.SingleWindowSlots == null) continue;
